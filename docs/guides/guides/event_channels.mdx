...
<Figure src="/img/event_channels/header.png" caption="Newly created event channels have a button for easy event creation" />
...
channel. This limit is increased to **50** if there is an active Premium membership.
